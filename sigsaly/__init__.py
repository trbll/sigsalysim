...
This package implements the full SIGSALY signal processing pipeline:
  ...
  scrambler.py      — Simplified A-3-style frequency inversion (pre-SIGSALY, crackable)
...
Historical context:
  Before SIGSALY, the Allies used the A-3 scrambler (a multi-band audio
  scrambling system), which the Germans cracked via spectral analysis
  by 1941. This simulator models A-3 with a simplified frequency-inversion
  demo that illustrates the same core vulnerability. SIGSALY replaced
